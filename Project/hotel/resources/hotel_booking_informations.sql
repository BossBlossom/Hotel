...
CREATE TABLE `booking_informations` (
  ...
  UNIQUE KEY `UK_beniqxyn1xauw68kg6fphfnwl` (`cmnd`),
  CONSTRAINT `FK8rnotgh9frf1e1gw7lr7w9ir1` FOREIGN KEY (`cmnd`) REFERENCES `customers` (`cmnd`),
...
-- Dump completed on 2018-10-19 20:33:23
