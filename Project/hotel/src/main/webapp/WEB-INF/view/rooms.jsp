		...
		<div id="myCarousel1" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
				<div class="item active">
					<img src='<spring:url value="resources/Home_resources/images/banner.png"/>' style="width: 100%; height: 500px"
						alt="First slide">
				...
				<div class="item">
					<img src='<spring:url value="resources/Home_resources/images/banner2.png"/>' style="width: 100%; height: 500px"
						alt="Second slide">
					<div class="carousel-caption">
						<h1>
							starhome<br> spa & Resort
				...
				<div class="item">
					<img src='<spring:url value="resources/Home_resources/images/banner3.png"/>' style="width: 100%; height: 500px"
						alt="Third slide">
					<div class="carousel-caption">
						<h1>
							starhome<br> spa & Resort
				...
				<div class="item">
					<img src='<spring:url value="resources/Home_resources/images/banner4.png"/>' style="width: 100%; height: 500px"
						alt="Forth slide">
					<div class="carousel-caption">
						<h1>
							starhome<br> spa & Resort
				...
				<div class="item">
					<img src='<spring:url value="resources/Home_resources/images/inner-banner.png"/>' style="width: 100%; height: 500px"
						alt="Fifth slide">
					<div class="carousel-caption">
						<h1>
							starhome<br> spa & Resort
				...
				<div class="row">
						...
						<div class="gallery-image">
							...
							<div class="overlay">
								<a class="info pop example-image-link img-responsive"
									href='<spring:url value="resources/Home_resources/images/room1.png"/>' data-lightbox="example-1"><i
					...
					<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
						<div class="gallery-image">
							...
							<div class="overlay">
								<a class="info pop example-image-link img-responsive"
									href='<spring:url value="resources/Home_resources/images/room2.png"/>' data-lightbox="example-1"><i
									class="fa fa-search" aria-hidden="true"></i></a>
								<p>
									<a>super room</a>
								</p>
					...
					<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
						<div class="gallery-image">
							...
							<div class="overlay">
								<a class="info pop example-image-link img-responsive"
									href='<spring:url value="resources/Home_resources/images/room3.png"/>' data-lightbox="example-1"><i
									class="fa fa-search" aria-hidden="true"></i></a>
								<p>
									<a>single room</a>
								</p>
					...
					<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
						<div class="gallery-image">
							...
							<div class="overlay">
								<a class="info pop example-image-link img-responsive"
									href='<spring:url value="resources/Home_resources/images/room4.png"/>' data-lightbox="example-1"><i
									class="fa fa-search" aria-hidden="true"></i></a>
								<p>
									<a>double room</a>
								</p>
					...
					<div class="row">
						<div class="col-md-5 col-sm-6 col-xs-12">
							<div class="vacation-offer-details">
								...
								<h4>Lorem ipsum dolor sit amet, conse ctetuer adipiscing
									elit.</h4>
							</div>
						</div>
					</div>
						...
						<div class="carousel-inner" role="listbox">
								...
								<div class="blog-view-box">
									<div class="media">
										<div class="media-left">
											<img src='<spring:url value="resources/Home_resources/images/client1.png"/>' class="media-object">
										</div>
							...
							<div class="item">
								...
								<div class="blog-view-box">
									<div class="media">
										<div class="media-left">
											<img src='<spring:url value="resources/Home_resources/images/client2.png"/>' class="media-object">
										</div>
										<div class="media-body">
							...
							<div class="item">
								...
								<div class="blog-view-box">
									<div class="media">
										<div class="media-left">
											<img src='<spring:url value="resources/Home_resources/images/client3.png"/>' class="media-object">
										</div>
										<div class="media-body">
			...
			<div class="container">
					...
					<div class="view-set-block">
						<div class="col-md-6 col-sm-6 col-xs-12">
							<div class="event-blog-image">
								<img alt="image" class="img-responsive" src='<spring:url value="resources/Home_resources/images/blog1.png"/>'>
							</div>
						</div>
				...
				<div class="row offspace-45">
					<div class="view-set-block">
						<div class="col-md-6 col-sm-6 col-xs-12">
							<div class="event-blog-image">
								<img alt="image" class="img-responsive" src='<spring:url value="resources/Home_resources/images/blog2.png"/>'>
							</div>
						</div>
						<div class="col-md-6 col-sm-6 col-xs-12 side-in-image">
							<div class="event-blog-details">
